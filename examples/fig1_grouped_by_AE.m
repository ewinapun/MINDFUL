%% Fig 1. Grouped ND by angle error

clear k params
params.excludeNonTrials = 1;
params.winlen = 3000;
params.updateHz = 3000;
params.xlabelFromDayZero = 1;
params.pcaDim = 5;
params.setBtwDays2NaN = 0;
...
k.SetReference(refData, ref_ind, header);
lastn = round(k.params.winlen/k.params.updateHz)-1;
...
text(20, 0.27, ...
    {info.participant,['r^2=',num2str(dlm.Rsquared.Ordinary,2)]}, ...
